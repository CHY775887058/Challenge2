...
public class PopTalentExperience implements PopupWindow.OnDismissListener,View.OnClickListener{
    ...
    public PopTalentExperience(Talent activity) {
        ...
        View view = LayoutInflater.from(mcontext).inflate(R.layout.talent_experience,null);
        initview(view);
    ...
    private void initview(View view) {
        ...
        complete = (Button) view.findViewById(R.id.btnCompelete);
